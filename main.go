...
func main() {
	...
	http.HandleFunc("/artists", func(w http.ResponseWriter, r *http.Request) { // Define the path for the artists page
		...
		tArtistes := template.Must(template.ParseFiles("./templates/artists.html"))
